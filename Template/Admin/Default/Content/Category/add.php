            ...
            <table class="t_table box add_box">
                ...
                <tr>
                    ...
                    <td colspan="3" id="linkType">
                        <label> <input type="radio" checked name="type" value="0" /> 内部链接</label>
                        <label> <input type="radio"  name="type" value="1" /> 外部连接链接</label>
                    </td>
                </tr>
                <tr>
                    <td > 栏目名：</td>
                ...
                <tr class="js_0">
                    <td>链接地址：</td>
                    <td colspan="3">
                       <input name="link" type="text" id="link" value="" style="width: 420px" />
                    </td>
                </tr>
...
?>
                ...
                <tr class="js_1">
                    <td>是否终极栏目：</td>
                    <td colspan="3"><input type="checkbox" value="1" name="isleaf"/></td>
                </tr>
                <tr class="js_1">
                    <td>关键字：</td>
                    <td colspan="3"><input type="text" name="keyword" style="width: 320px"/></td>
                </tr>
                <tr class="js_1">
                    <td>描述：</td>
                    <td colspan="3">
                        <textarea name="desc" rows="5" id="description" style="height:50px;width: 400px"></textarea>
                    </td>
                </tr>
                <tr >
                    <td colspan="4">
