            ...
            <table class="top_btn t_table" >
                <tr>
                    <td align="center" height="30">
                        <a href="<?php echo U('Content/Article/add', array('mid' => $_GET['mid'], 'cid' => $_GET['cid'], 'category' => $category_name)); ?>" class="np coolbg">添加文档</a>                   
                    </td>
                </tr>
            </table>
                ...
                <tbody>
                    ...
                    foreach ($result as $r)
                    {
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <a href="<?php echo U('Content/Article/edit', array('id' => $r['id'])); ?>">编辑</a>
                                <a  onclick="return confirm('删除后无法恢复,确定要删除吗')" href="<?php echo U('Content/Article/del', array('id' => $r['id'])); ?>">删除</a>
