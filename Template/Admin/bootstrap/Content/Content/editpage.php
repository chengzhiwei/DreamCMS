                        ...
                        <div class="col-xs-12">
                            <form role="form" class="form-horizontal" method="post" onsubmit="return chkform()">
                                ...
                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-1 control-label no-padding-right"> <?php echo L('TITLE'); ?> </label>
                                    <div class="col-sm-11  pull-left" >
                                        <input type="text" value="<?php echo $pageinfo['title'] ?>"  class="col-xs-10 col-sm-11" name="title">
                                    </div>

                                </div>

                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-1 control-label no-padding-right"> <?php echo L('keyword'); ?> </label>
                                    <div class="col-sm-11  pull-left" >
                                        <input type="text" value="<?php echo $pageinfo['keyword'] ?>"  class="col-xs-10 col-sm-11" name="keyword">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-1 control-label no-padding-right"> <?php echo L('desc'); ?> </label>
                                    <div class="col-sm-11  pull-left" >
                                        <textarea name="desc"  class="col-xs-10 col-sm-11"><?php echo $pageinfo['desc'] ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="form-field-1" class="col-sm-1 control-label no-padding-right"> <?php echo L('CONTENT'); ?> </label>
                                    <div class="col-sm-11  pull-left" >
                                        <?php
                                        $f = array(
